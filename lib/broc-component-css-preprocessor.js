...
function guid(appName, componentName) {
  return crc32(appName + ':' + componentName).toString(36);
};
    ...
    for (var i = 0, l = paths.length; i < l; i++) {
      ...
      if (filepath[filepath.length-1] !== '/') {
        ...
        if (podClassName in guidCache) {
          ...
          podGuid = guidCache[podClassName] = podClassName + '-' + guid(appName, podClassName);
        }
