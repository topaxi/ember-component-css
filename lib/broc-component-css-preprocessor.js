...
var processors = {
  css: function(fileContents, podGuid) {
    return postcssProcessor(podGuid).process(fileContents).css;
  },

  scss: function(fileContents, podGuid) {
    return postcssProcessor(podGuid).process(fileContents, {
...
function postcssProcessor(podGuid) {
  return postcss()
